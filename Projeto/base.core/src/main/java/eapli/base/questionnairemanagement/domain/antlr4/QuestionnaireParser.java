...
public class QuestionnaireParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'?'", "'Type:'", "'Free-Text'", "'Single-choice'", "'Single-Choice-Input'", 
			"'Multiple-choice'", "'Multiple-Choice-Input'", null, null, null, null, 
			null, null, null, null, null, null, null, null, null, "'Obligatoriness: Mandatory.'", 
